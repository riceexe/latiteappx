...
powershell -command "& {Start-BitsTransfer -DisplayName "Downloading..." -Source "https://github.com/riceexe/latiteappx/releases/download/1.19.61/1.19.61.appx" -Destination "%LatiteDir%\latite.appx"}"

:: Download and add certificate
echo Adding cert...
powershell -command "& {Start-BitsTransfer -DisplayName "Downloading..." -Source "https://github.com/riceexe/latiteappx/releases/download/1.19.61/1.19.61.cer" -Destination "%LatiteDir%\latite.cer"}"
